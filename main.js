...
document.querySelector('.huati').addEventListener('click', function () {
  ...
  fetch("http://8.134.148.60:4000/article/articleTopicsCovers?page=1&size=5&topic=topic", requestOptions)
